      ...
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-600 dark:text-dark-text-secondary">
            Or{' '}
            <Link href="/register" className="font-medium text-[#00D9CF] dark:text-dark-brand-turquoise hover:text-[#00C5E3] dark:hover:text-dark-brand-teal">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <input
                ...
                name="remember-me"
                type="checkbox"
                className="h-4 w-4 text-[#00D9CF] dark:text-dark-brand-turquoise focus:ring-[#00D9CF] dark:focus:ring-dark-brand-turquoise border-gray-300 dark:border-dark-border rounded"
              />
            ...
            <div className="text-sm">
              <Link href="/forgot-password" className="font-medium text-[#00D9CF] dark:text-dark-brand-turquoise hover:text-[#00C5E3] dark:hover:text-dark-brand-teal">
